...
export default function RecipeTitle({ title, cookingTime, calories, description, store_recipe = false }: RecipeTitleProps) {
    return (
        <div className="self-stretch flex flex-col justify-start items-start gap-5 px-5">
            <div className="self-stretch inline-flex justify-start items-center gap-5">
                <div className="w-80 inline-flex flex-col justify-start items-start gap-2.5">
                    ...
                    <div className="self-stretch justify-start text-zinc-800 text-sm font-normal font-['Noto_Sans_JP'] leading-tight">調理時間{cookingTime} {calories}</div>
                </div>
                <BookMarkToggle store_recipe={store_recipe}/>
            </div>
