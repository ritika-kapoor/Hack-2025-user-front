...
export default function RecipeTitle({ title, cookingTime, calories, description, recipe_id, saved_flg}: RecipeTitleProps) {
    return (
        <div className="self-stretch flex flex-col justify-start items-start gap-5 px-5">
            <div className="self-stretch inline-flex justify-start items-center gap-5">
                ...
                <BookMarkToggle recipe_id={recipe_id} saved_flg={saved_flg}/>
            </div>
